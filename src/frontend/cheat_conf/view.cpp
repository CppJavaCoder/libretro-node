...
View::View(RETRO::Core& core, RETRO::Cheat::Block& block, RETRO::Cheat::Block& user_block) :
    m_core{&core},
    m_block{&block},
...
void View::ShowTree(RETRO::Cheat::Block* block, bool can_edit)
{
    RETRO::Cheat::Entry* parent_entry{};

    for (auto& [_, v] : block->entries)
        ShowTreeNode(v, parent_entry, can_edit);
}

void View::ShowTreeNode(RETRO::Cheat::Entry& entry, RETRO::Cheat::Entry* parent_entry, bool can_edit)
{
...
void View::ShowTreeNodeGroup(RETRO::Cheat::Entry& entry, RETRO::Cheat::Entry* parent_entry, bool can_edit)
{
    ImGui::PushID(&entry);
...
void View::ShowTreeNodeOptions(RETRO::Cheat::Entry& entry, RETRO::Cheat::Entry* parent_entry, bool can_edit)
{
    ImGui::PushID(&entry);
...
void View::ShowTreeNodeSingle(RETRO::Cheat::Entry& entry, RETRO::Cheat::Entry* parent_entry, bool can_edit)
{
    ImGui::PushID(&entry);
...
void View::ShowItemContextMenu(RETRO::Cheat::Entry* parent_entry, RETRO::Cheat::Entry* entry, bool delete_only)
{
...
void View::NewEntry() {
    ...
    RETRO::Cheat::Entry* entry, *parent_entry{};
    std::map<std::string, RETRO::Cheat::Entry>* entries = &m_user_block->entries;
    std::vector<RETRO::Cheat::Entry*> entries_to_disable;
...
void View::DisableTreeNode(RETRO::Cheat::Entry& entry)
{
    if (!entry.entries.empty()) {
        for (auto& [_, v] : entry.entries)
            DisableTreeNode(v);
...
void View::DisableEntry(RETRO::Cheat::Entry& entry)
{
    if (entry.enabled) {
