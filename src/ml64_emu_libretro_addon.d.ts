...
export module Frontend {
    ...
    export module Sprite{
        export function fromImage(imFile: string,w: number,h: number,cols: number,rows: number): number;
        export function fromSurface(srf: Buffer,w: number,h: number,cols: number,rows: number): number;
        export function fromBuffer(pixels: Buffer,pitch: number,w: number,h: number,cols: number,rows: number): number;
...
export module Retro {
	...
	export function loadGameSpecial(game_type: number, file: string, num_info: number): boolean;
	export function unloadGame(): void;

    export function init(): void;
    export function deinit(): void;
    export function getAPIVersion(): number;
    export function getSystemInfo(): retro_system_info;
	export function getSystemAvInfo() : retro_system_av_info;
	export function setControllerPortDevice(port: number, device: number): void;
